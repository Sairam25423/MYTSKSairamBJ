...
namespace MYTSKSairamBolloju.MYTSK {
    ...
    public partial class MYData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string Designation, int DepartmentId, string DepartmentName, System.DateTime HireDate, bool IsActive) {
...
namespace MYTSKSairamBolloju.MYTSK.MYDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Employees] ([FirstName], [LastName], [Designation], [DepartmentId], " +
                "[DepartmentName], [HireDate], [IsActive]) VALUES (@FirstName, @LastName, @Design" +
                "ation, @DepartmentId, @DepartmentName, @HireDate, @IsActive)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Employees] SET [FirstName] = @FirstName, [LastName] = @LastName, [Designation] = @Designation, [DepartmentId] = @DepartmentId, [DepartmentName] = @DepartmentName, [HireDate] = @HireDate, [IsActive] = @IsActive WHERE (([EmployeeID] = @Original_EmployeeID))";
        ...
        public virtual int Fill(MYData.EmployeesDataTable dataTable) {
        ...
        public virtual MYData.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MYData.EmployeesDataTable dataTable = new MYData.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MYData.EmployeesDataTable dataTable) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Designation, global::System.Nullable<int> DepartmentId, string DepartmentName, global::System.Nullable<global::System.DateTime> HireDate, global::System.Nullable<bool> IsActive) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Designation, global::System.Nullable<int> DepartmentId, string DepartmentName, global::System.Nullable<global::System.DateTime> HireDate, global::System.Nullable<bool> IsActive, int Original_EmployeeID) {
            if ((FirstName == null)) {
